...
from .views import ToDo, ToDoDetail, TaskCreate, TaskUpdate, DeleteTask, TeacherToDo, ClassCreate, ClassView, ClassUpdate, ClassDetails, AddStudent, DeleteClass, ViewGrades
